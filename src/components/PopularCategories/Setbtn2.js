...
import bg1 from "./images2/vegan.jpg";
import bg2 from "./images2/pasta.jpg";
import bg3 from "./images2/pizza.jpg";
import ApiCall2 from "./ApiCall2";

export default function Setbtn2() {
  ...
  return (
    <>
      ...
      <div className="container-fluid container nav_bg">
        <div className="row">
          <div className=" mx-auto">
