...
import Pastabg from "./images2/pastabg.jpg";
 import Cards2 from "./Cards2";

export default function PastaApi() {
  const [getFullData, setgetFullData] = useState([]);

  const backgroundStyle = {
    backgroundImage: `url(${Pastabg})`,
    ...
    const getDeliciousFood = async () => {
      try {
        const res = await axios.get(
          ...
          "https://api.edamam.com/api/recipes/v2?type=public&q=pasta&app_id=cb9a6a22&app_key=607d5b31a3c0de4c5ae27468259004a7"
        );
